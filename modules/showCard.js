              ...
              <div class="card togglecart-2 z-depth-4 select" id= "${id}">
                ...
                <div class="description-togglecart-2">
                  ...
                  <div class="details-property left" id= "${id}"><span class="bed-number"><img src="../images/bed.png">Beds
                      ${roomnumber}</span><span class="bath-number" id= "${id}"><img src="../images/bath.png">Baths ${bathroomnumber}</span><span
                      class="sqft-number"><img id= "${id}" src="../images/size.png">${squaremeters}
                      Sqft</span>
                  </div>
                </div>
              </div>
